    ...
    internal partial class Consensus : IDisposable
    {
        ...
        internal void FetchConsensus(Options options)
        {
            ...
            if (   (0 == (options & Options.ForceDownload))
                ...
                && File.Exists(CachedConsensusFileName))
            {
                consensusContent = File.ReadAllText(CachedConsensusFileName);
            }
        ...
        /// <remarks>During our testing (summer 2016) we witnessed the following
        /// responsivness :
        /// maatuska - OK
        /// dizum - OK
        /// tor26 - OK
        /// dannenberg - OK</remarks>
